...
if(is_array($row)){
    ...
    if($sptype=='auto')
    {
        $body = SpLongBody($body,$spsize*1024,"#p#");
    }
	...
	$description = str_replace('#p#分页标题#e#','',$description);
	$description = str_replace('#p#','',$description);
	$description = str_replace('#e#','',$description);
	$description = str_replace('分页标题','',$description);
	$description = str_replace('副标题 ','',$description);
	$description = str_replace('副标题','',$description);
